...
# ================================================================== RUN PREDICTION ==================================================================#
o_file = '../../Results/predictions/R3_continous_scores_below38w.txt'
...
subjects = pd.read_csv('../../DerivedData/subjects_below_38w.csv', names=['subject_id', 'session_id'] )
...
for cohort in ['38w']:
	...
	sub_df = df[df.subject_id.isin(subjects.subject_id.values)].copy()
	...
	for random_parc_num in [128, 256, 512, 1024]:
		...
		random_df = random_df[random_df.subject_id.isin(subjects.subject_id.values)].copy()
