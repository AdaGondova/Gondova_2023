...
num_rep = 100 # for repeated k-fold
...
# ================================================================== RUN PREDICTION ==================================================================#
o_file = '../../Results/predictions/prematurity_prediction_results_E.txt'
...
for cohort in ['E']:
	...
	for random_parc_num in [128, 256, 512, 1024]:
		...
		random_df = pd.merge(random_df, sub_df[['subject_id', 'group_cat', 'PMA_scan']], on='subject_id', how='inner')
